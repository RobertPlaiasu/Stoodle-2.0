...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->foreignId('subject_id_1')->nullable()->default(NULL);
            $table->foreignId('subject_id_2')->nullable()->default(NULL);
            $table->foreignId('subject_id_3')->nullable()->default(NULL);
            $table->timestamps();
        });
